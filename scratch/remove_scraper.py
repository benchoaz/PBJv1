...
code = code.replace(launch_new, launch_old)

interception_code = """    const page = await browser.newPage();
...
code = code.replace(interception_code, '    const page = await browser.newPage();')

with open('/home/ubuntu/PBJv1/survey-service/server.js', 'w') as f:
    f.write(code)

print("ScraperAPI removed!")
